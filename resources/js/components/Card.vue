<template>
    <card class="flex flex-col items-center justify-center">
        <div class="w-full px-3 py-3">
            <h1 v-show="card.showtitle" class="text-center text-3xl text-80 font-light">{{ card.title }}</h1>
            <div class="flex flex-row content-center items-center border-b border-gray-200" v-for="time in this.times" :key="time.name">
